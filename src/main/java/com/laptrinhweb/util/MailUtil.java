...
public class MailUtil {
	...
	/*
	 * Mỗi khi gọi phương thức sendMailResetPassword(), một Runnable được gửi đến
	 * ExecutorService để thực thi việc gửi email trên một thread riêng biệt.
	 * ExecutorService giúp bạn tạo và quản lý các thread để thực hiện công việc gửi
	 * email một cách bất đồng bộ
	 */
	...
	public void sendMailResetPassword(UserDto userDto, String newPassword) {
		executorService.submit(() -> {
			try {
				...
				content.append("<p>Xin ch&agrave;o <strong>").append(userDto.getFullName()).append("</strong>.</p>")
						.append("<p>Ch&uacute;ng t&ocirc;i đến từ <strong>Organi.com</strong>, xin th&ocirc;ng b&aacute;o rằng mật khẩu của bạn đ&atilde; được đổi th&agrave;nh c&ocirc;ng.</p>")
						.append("<p>T&ecirc;n đăng nhập: <strong>").append(userDto.getUserName())
						.append("</strong></p>").append("<p>Mật khẩu mới của bạn l&agrave;:<strong>")
						.append(newPassword).append("</strong></p>")
	...
	public void sendMailVerifyUser(UserDto userDto) {
		executorService.submit(() -> {
			try {
				...
				StringBuilder content = new StringBuilder();
				content.append("<p>Ch&agrave;o bạn <em><strong>").append(userDto.getFullName())
						.append("</strong></em>,</p>")
						...
						.append("<p><a href=\"http://localhost:8080/Organi/xac-thuc-nguoi-dung?id=")
						.append(userDto.getId()).append("&verifyCode=").append(userDto.getVerifyCode()).append("\"")
