                                ...
                                <div class="col-lg-9 col-md-12">
                                    <div class="dash__box dash__box--shadow dash__box--radius dash__box--bg-white">
                                        <div class="dash__pad-2">
                                            <h1 class="dash__h1 u-s-m-b-14">Chỉnh sửa thông tin</h1>
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <form:form class="dash-edit-p" action="chinh-sua-thong-tin" modelAttribute="user" method="POST" >
                                                        <div class="gl-inline">
                                                            <div class="u-s-m-b-30">
                                                                <h2 class="dash__h2 u-s-m-b-8">Họ tên</h2>
                                                                <form:input class="input-text input-text--primary-style" type="text" path="fullName"/>
                                                            </div>
                                                            <div class="u-s-m-b-30">
                                                                <h2 class="dash__h2 u-s-m-b-8">E-mail</h2>
                                                                <form:input class="input-text input-text--primary-style" type="text" path="email"/>
                                                            </div>
                                                        </div>
                                                        <div class="gl-inline">
                                                            <div class="u-s-m-b-30">
                                                                <h2 class="dash__h2 u-s-m-b-8">Số điện thoại</h2>
                                                                <form:input class="input-text input-text--primary-style" type="text" path="phoneNumber"/>
                                                            </div>
                                                        </div>
