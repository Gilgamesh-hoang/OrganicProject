                      ...
                      <div class="col-lg-6 col-md-8 u-s-m-b-30">
                          <div class="l-f-o">
                              <div class="l-f-o__pad-box">
                                  ...
                                  <span class="gl-text u-s-m-b-30">Nhập vào tên đăng nhập và email của bạn vào bên dưới, chúng tôi sẽ gửi cho bạn mật khẩu đã được đặt lại!</span>
                                  <form class="l-f-o__form">
                                      <div class="u-s-m-b-30">

                                          <label class="gl-label" for="reset-username">Tên đăng nhập *</label>

                                          <input class="input-text input-text--primary-style" type="text" id="reset-username" placeholder="Nhập tên đăng nhập" required="required"></div>
                                      <div class="u-s-m-b-30">

                                          <label class="gl-label" for="reset-email">E-Mail *</label>

                                          <input class="input-text input-text--primary-style" type="email" id="reset-email" placeholder="Nhập E-mail" required="required"></div>
                                      <div class="u-s-m-b-30">
